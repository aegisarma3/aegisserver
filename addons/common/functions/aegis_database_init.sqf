...
try
{
	...
	format ["Versao do extDB2: %1", _result] call aegis_log;
	...
	"Conectado no banco de dados!" call aegis_log;
	...
	"Protocolo do banco de dados inicializado!" call aegis_log;
	"extDB2" callExtension "9:LOCK";
	_isConnected = true;
}
catch
{
	"Erro de conexao com o MySQL!" call aegis_log;
	"Verifique a pasta @extDB2/extDB/logs/ para ver o que deu errado." call aegis_log;
	format ["Erro do MySQL: %1", _exception]  call aegis_log;
	"O server ira desligar agora." call aegis_log;
